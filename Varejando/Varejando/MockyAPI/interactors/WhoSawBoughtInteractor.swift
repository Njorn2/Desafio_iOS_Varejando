...
protocol WhoSawBoughtOutput: ProductsSimpleInteractorOutput {
}

class WhoSawBoughtInteractor: ProductsSimpleInteractorInput {
    weak var output: WhoSawBoughtOutput?
